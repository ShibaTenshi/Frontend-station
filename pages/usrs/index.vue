...
export default {
    ...
    methods:{
        goToManages(){
            navigateTo('usrs/manages')
        },
        goToTableAvali(){
            navigateTo('usrs/manages/tableAvalibility')
        },
        goToManageQuese(){
            navigateTo('usrs/manages/queue')
        },
        goToInformation(){
            navigateTo('usrs/information')
        }
    }
}
</script>
<style scoped src="@/assets/styles/usrs.css"></style>